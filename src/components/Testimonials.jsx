...
const testimonialsData = [
  {
    ...
    content:
      "Our new website designed by Tailcast has significantly improved our online presence. The design is modern, user-friendly, and we've seen a noticeable increase in engagement and conversions. Truly a game-changer for our business!",
    image: testimonial1,
  },
  {
    customerName: "John Watkins",
...
export const Testimonials = () => (
  <section className="w-full flex justify-center py-16 sm:py-20 lg:py-24 bg-bgDark2 relative">
